...
def init_thebe_core(app, env, docnames):
    ...
    app.add_js_file(None, body=f"var thebePythonReady = '{translate('Python interaction ready!')}';")
    app.add_js_file(None, body=f"var thebeRunningCells = '{translate('Running pre-initialized cells...')}';")
    app.add_js_file(None, body=f"var thebeLoadingThebe = '{translate('Loading Thebe...')}';")
    app.add_js_file(None, body=f"var thebeWaitingForPackages = '{translate('Waiting for packages to load...')}';")
    app.add_js_file(None, body=f"var thebeLaunchingPyodide = '{translate('Launching Pyodide kernel')}';")
    app.add_js_file(None, body=f"var thebeInitializingThebe = '{translate('Initializing Thebe')}';")
    app.add_js_file(None, body=f"var thebeDeleteCell = '{translate('delete cell')}';")
    app.add_js_file(None, body=f"var thebeDeleteThisCell = '{translate('delete this cell')}';")
    app.add_js_file(None, body=f"var thebeClear = '{translate('clear')}';")
    app.add_js_file(None, body=f"var thebeClearOutput = '{translate('clear the output of the cell')}';")
    app.add_js_file(None, body=f"var thebeAddCell = '{translate('add cell')}';")
    app.add_js_file(None, body=f"var thebeAddNewCell = '{translate('adds a new cell underneath')}';")
    app.add_js_file(None, body=f"var thebeLaunchingBinder = '{translate('Launching from mybinder.org')}';")
    app.add_js_file(None, body=f"var thebeLoadingCDN = '{translate('Loading thebe from CDN...')}';")
    app.add_js_file(None, body=f"var thebeRun = '{translate('run')}';")
    app.add_js_file(None, body=f"var thebeRunCell = '{translate('run this cell')}';")
    app.add_js_file(None, body=f"var thebeRunAll = '{translate('run all')}';")
    app.add_js_file(None, body=f"var thebeRunAllCells = '{translate('run all cells')}';")
    app.add_js_file(None, body=f"var thebeRestartRun = '{translate('restart & run all')}';")
    app.add_js_file(None, body=f"var thebeRestartRunCells = '{translate('restart the kernel and run all cells')}';")
    app.add_js_file(None, body=f"var thebeLiveCode = '{translate('Live Code')}';")
    app.add_js_file(None, body=f"var thebeLaunchThebe = '{translate('Launch Thebe')}';")

    # Persistence i18n
    app.add_js_file(None, body=f"var thebeExportLabel = '{translate('export')}';")
    app.add_js_file(None, body=f"var thebeExportTitle = '{translate('download all saved progress as JSON')}';")
    app.add_js_file(None, body=f"var thebeImportLabel = '{translate('import')}';")
    app.add_js_file(None, body=f"var thebeImportTitle = '{translate('restore progress from a JSON file')}';")
    app.add_js_file(None, body=f"var thebeImportError = '{translate('Import failed: invalid file format.')}';")
    app.add_js_file(None, body=f"var thebeResetLabel = '{translate('reset')}';")
    app.add_js_file(None, body=f"var thebeResetTitle = '{translate('Reset saved progress')}';")
    app.add_js_file(None, body=f"var thebeResetWarning = '{translate('This will clear saved code from localStorage and cannot be undone.')}';")
    app.add_js_file(None, body=f"var thebeResetPage = '{translate('This page only')}';")
    app.add_js_file(None, body=f"var thebeResetAll = '{translate('Entire book')}';")
    app.add_js_file(None, body=f"var thebeResetCancel = '{translate('Cancel')}';")
